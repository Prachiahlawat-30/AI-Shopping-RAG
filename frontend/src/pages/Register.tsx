...
export default function Register() {
  return (
    <div className="min-h-screen bg-[#07090e] text-zinc-100 flex flex-col justify-center items-center px-4 py-12 relative overflow-hidden font-sans selection:bg-indigo-500 selection:text-white">
      ...
      <div className="absolute top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-gradient-to-tr from-purple-600/20 via-indigo-600/15 to-transparent blur-[140px] pointer-events-none -z-10" />
      ...
      <div className="w-full max-w-5xl grid grid-cols-1 lg:grid-cols-12 gap-8 items-center z-10">
        ...
        <div className="hidden lg:flex lg:col-span-6 flex-col justify-center space-y-6 pr-6">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-purple-950/70 border border-purple-500/30 text-purple-300 text-xs font-semibold w-fit">
          ...
          <p className="text-zinc-400 text-sm leading-relaxed max-w-md">
            Join the multimodal shopping platform to index product collections, search visually across catalogs, and chat with an intelligent shopping copilot.
          </p>

          <div className="space-y-3 pt-2">
            {[
              { icon: Eye, title: "Multi-Angle Photo Analysis", desc: "Automated vision extraction and fusion" },
              { icon: Zap, title: "Two-Stage Re-Ranking", desc: "Accurate lexical + semantic score fusion" },
              { icon: ShieldCheck, title: "Private Vector Indexing", desc: "100% tenant-isolated Qdrant payloads" },
            ].map((item, idx) => {
              const Icon = item.icon;
              return (
                <div key={idx} className="flex items-start gap-3 p-3 rounded-2xl bg-zinc-900/40 border border-zinc-800/80">
                  <div className="w-8 h-8 rounded-xl bg-purple-950/80 border border-purple-500/30 flex items-center justify-center text-purple-400 shrink-0">
        ...
        {/* Right Side: Enhanced High-Contrast Clerk SignUp Card */}
        <div className="lg:col-span-6 flex justify-center">
          <div className="w-full max-w-[440px] rounded-3xl p-1 bg-gradient-to-b from-purple-500/30 via-zinc-800 to-zinc-900/80 shadow-2xl shadow-black/80">
